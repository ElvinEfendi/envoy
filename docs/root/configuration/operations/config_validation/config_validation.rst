...
allows a trusted in-process module to inspect decoded State-of-the-World and delta xDS resources
before Envoy accepts an update. A module rejection follows the normal xDS NACK path.
